 ...
 */
/*
 * $Id: JMonth.java,v 1.12 2005/10/10 18:02:45 rbair Exp $
 * 
 ...
 * or range of days.  By default the <code>JMonth</code> will display a
 * single calendar using the current month and year, using
 * <code>Calendar.SUNDAY</code> as the first day of the week.
 * <p> 
 * The <code>JMonth</code> can be configured to display more than one
 ...
 * </pre>
 * <p>
 * <code>JMonth</code> can be further configured to allow any day of the
 ...
 *    monthView.setSelectionMode(JMonth.WEEK_SELECTION);
 *
 ...
 *            System.out.println(
 *                ((JMonth)e.getSource()).getSelectedDateSpan());
 *        }
 *    });
 * </pre>
 *
 ...
 */
public class JMonth extends JComponent {
    ...
    /**
     * Create a new instance of the <code>JMonth</code> class using the
    ...
    public void setMonthNames(String[] month){
        _monthsOfTheYear = month;
    }
    
    public JMonth(long initialTime) {
        super();
    ...
    public void updateUI() {
        ...
        String[] daysOfTheWeek =
                (String[])UIManager.get("JMonth.daysOfTheWeek");
        ...
        Color color =
            UIManager.getColor("JMonth.monthStringBackground");
        if (color == null) {
            color = new Color(138, 173, 209);
        }
        setMonthStringBackground(color);

        color = UIManager.getColor("JMonth.monthStringForeground");
        if (color == null) {
            color = new Color(68, 68, 68);
        }
        setMonthStringForeground(color);
        
        color = UIManager.getColor("JMonth.daysOfTheWeekForeground");
        if (color == null) {
            color = new Color(68, 68, 68);
        }
        setDaysOfTheWeekForeground(color);

        color = UIManager.getColor("JMonth.selectedBackground");
        if (color == null) {
            color = new Color(197, 220, 240);
        }
        setSelectedBackground(color);

        Font font = UIManager.getFont("JMonth.font");
        if (font == null) {
        ...
        String imageLocation =
            UIManager.getString("JMonth.monthDownFileName");
        if (imageLocation == null) {
            imageLocation = "IMG/month-down.png";
        }
        _monthDownImage = new ImageIcon(
            JMonth.class.getResource(imageLocation));

        imageLocation = UIManager.getString("JMonth.monthUpFileName");
        if (imageLocation == null) {
            imageLocation = "IMG/month-up.png";
        }
    ...
    /**
     * Returns the current selection mode for this JMonth.
     *
    ...
    /**
     * Set the selection mode for this JMonth.
     *
     ...
     * Gets the time zone.
     *
     * @return The <code>TimeZone</code> used by the <code>JMonth</code>.
     */
    ...
    */
     ...
     * is the background of the <code>JMonth</code> component.
     * 
...
//        g.drawRect(x, y, width - 1, height - 1);
    ...
    /**
     * Class that supports keyboard traversal of the JMonth component.
     */
